...
Finally, the group's involvement in LZ and XLZD connects to my existing work within the liquid xenon dark matter community through Nikhef, and would allow me to contribute to the broader experimental program while developing new expertise in superconducting detector technologies. I do not have prior experience with TES or SNSPD sensors, dilution refrigerators, or underground operations, but my trajectory, from computational work on g-2 to hands-on detector R&D on VULCAN, with each step adding hardware skills to my analysis foundation, has been deliberately aimed at building the kind of broad experimental capability that this position requires. 